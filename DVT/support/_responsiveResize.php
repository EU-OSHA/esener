...
<html>
	<body>
		<section style="width:920px">
			...
			<hr>
			<h2>DVS2 responsive engine - 920px width *</h2>
		...
		<section style="width:830px">
			<h2>DVS2 responsive engine - 830px width </h2>
			<img id="visualization" width="100%" src="<?php echo $visualizationUrl; ?>">
		</section> <br/>
		
		<?php $visualizationUrl = str_replace("width=920","width=740", $visualizationUrl); ?>
		<section style="width:740px">
			<h2>DVS2 responsive engine - 740px width * </h2>
			<img id="visualization" width="100%" src="<?php echo $visualizationUrl; ?>">
		</section> <br/>
		
		<section style="width:620px">
			<h2>DVS2 responsive engine - 620px width </h2>
			<img id="visualization" width="100%" src="<?php echo $visualizationUrl; ?>">
		</section> <br/>
		...
		<section style="width:500px">
			<h2>DVS2 responsive engine - 500px width * </h2>
			<img id="visualization" width="100%" src="<?php echo $visualizationUrl; ?>">
		</section><br/>
		
		<section style="width:400px">
			<h2>DVS2 responsive engine - 400px width </h2>
			<img id="visualization" width="100%" src="<?php echo $visualizationUrl; ?>">
		</section><br/>
	</body>
</html>