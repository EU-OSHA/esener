...
um.baseSRC = path.replace('udm-custom.js','');
...
um.navbar = [
	...
	"11em",	// width ["em"|"ex"|"px"] (vertical navbar only - horizontal navbar items have "auto" width) ("%" doesn't work right)
	];
...
um.items = [
	...
	"#D0DDEB",// border colors ["color"|"#hex"|"rgb()"] (single, double or four values)
	"solid",	// border styles ["solid"|"double"|"dotted"|"dashed"|"groove"|"ridge"|"inset"|"outset"] (single, double or four values; be careful with using "none")
	"#D0DDEB",// hover/focus border colors ["color"|"#hex"|"rgb()"] (single, double or four values)
	"solid",	// hover/focus border styles ["solid"|"double"|"dotted"|"dashed"|"groove"|"ridge"|"inset"|"outset"] (single, double or four values; be careful with using "none")
	"#D0DDEB",// visited border colors ["color"|"#hex"|"rgb()"] (single, double or four values)
	...
	"#F2F6FA",		// background ["color"|"#hex"|"rgb()"|"image.gif"]
	"#F2F6FA",		// hover/focus background ["color"|"#hex"|"rgb()"|"image.gif"]
	"#F2F6FA",		// visited background ["color"|"#hex"|"rgb()"|"image.gif"]
	...
	"#3D4B98",	// color ["color"|"#hex"|"rgb()"]
	"#FF6000",	// hover/focus color ["color"|"#hex"|"rgb()"]
	"#3D4B98",	// visited color ["color"|"#hex"|"rgb()"]
	...
	"right-navblue.gif",// menu indicator character/image ["text"|"image.gif"|"none"]
	"right-navblue.gif",// menu indicator rollover character/image ["text"|"image.gif"|"none"] (must be same type)
